Vue.component('main-navigation', {
    ...
    <v-navigation-drawer class="blue-grey lighten-5" v-model="drawer_local" app right>
        ...
        <!-- Home -->
        <v-btn href="../MySite_1/index.html" class="font-weight-black non-underline" block dark>
        ...
        <v-list nav dense>
            ...
            <v-list-group :value="false" prepend-icon="mdi-book-open-page-variant-outline">
                ...
                <v-list-item href="../MySite_1/points_learning.html">
                    <v-list-item-icon />
                    <v-list-item-title>Learning Points</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/character.html">
                    <v-list-item-icon />
                    <v-list-item-title>Character</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/grammar.html">
                    <v-list-item-icon />
                    <v-list-item-title>Grammar</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/asking.html">
                    <v-list-item-icon />
                    <v-list-item-title>Asking</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/word_general.html">
                    <v-list-item-icon />
                    <v-list-item-title>Word - General</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/word_verb.html">
                    <v-list-item-icon />
                    <v-list-item-title>Word - Verb</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/word_adjective_i.html">
                    <v-list-item-icon />
                    <v-list-item-title>Word - Adjective - i</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/word_adjective_na.html">
                    <v-list-item-icon />
                    <v-list-item-title>Word - Adjective - na</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Basic/word_adverb.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Word/word_food.html">
                    <v-list-item-icon />
                    <v-list-item-title>General</v-list-item-title>
                </v-list-item>

                <v-list-item href="../MySite_1/Japanese/Word/word_food_chinese.html">
                    <v-list-item-icon />
                    <v-list-item-title>Chinese</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_italian.html">
                    <v-list-item-icon />
                    <v-list-item-title>Italian</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_seafood.html">
                    <v-list-item-icon />
                    <v-list-item-title>Seafood</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_seasoning.html">
                    <v-list-item-icon />
                    <v-list-item-title>Seasoning</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_sushi.html">
                    <v-list-item-icon />
                    <v-list-item-title>Sushi</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_vegetable.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Word/word_art.html">
                    <v-list-item-icon />
                    <v-list-item-title>Art</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_math.html">
                    <v-list-item-icon />
                    <v-list-item-title>Math</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_music.html">
                    <v-list-item-icon />
                    <v-list-item-title>Music</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_outdoor.html">
                    <v-list-item-icon />
                    <v-list-item-title>Outdoor</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_reading.html">
                    <v-list-item-icon />
                    <v-list-item-title>Reading</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_sf.html">
                    <v-list-item-icon />
                    <v-list-item-title>SF</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_sport.html">
                    <v-list-item-icon />
                    <v-list-item-title>Sport</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_travel.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Word/word_body.html">
                    <v-list-item-icon />
                    <v-list-item-title>Body</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_computer.html">
                    <v-list-item-icon />
                    <v-list-item-title>Computer</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_game.html">
                    <v-list-item-icon />
                    <v-list-item-title>Game</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_house.html">
                    <v-list-item-icon />
                    <v-list-item-title>House</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_kitchen.html">
                    <v-list-item-icon />
                    <v-list-item-title>Kitchen</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_time.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Word/word_nature.html">
                    <v-list-item-icon />
                    <v-list-item-title>General</v-list-item-title>
                </v-list-item>
                
                <v-list-item href="../MySite_1/Japanese/Word/word_animal.html">
                    <v-list-item-icon />
                    <v-list-item-title>Animal</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_forest.html">
                    <v-list-item-icon />
                    <v-list-item-title>Forest</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_plant.html">
                    <v-list-item-icon />
                    <v-list-item-title>Plant</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_river.html">
                    <v-list-item-icon />
                    <v-list-item-title>River</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_sea.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Word/word_cafe.html">
                    <v-list-item-icon />
                    <v-list-item-title>Cafe</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_clothes_store.html">
                    <v-list-item-icon />
                    <v-list-item-title>Clothes</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_hospital.html">
                    <v-list-item-icon />
                    <v-list-item-title>Hospital</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_restaurant.html">
                    <v-list-item-icon />
                    <v-list-item-title>Restaurant</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_supermarket.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Word/word_company.html">
                    <v-list-item-icon />
                    <v-list-item-title>Company</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_gym.html">
                    <v-list-item-icon />
                    <v-list-item-title>Gym</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_park.html">
                    <v-list-item-icon />
                    <v-list-item-title>Park</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_road.html">
                    <v-list-item-icon />
                    <v-list-item-title>Road</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_school.html">
                    <v-list-item-icon />
                    <v-list-item-title>School</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_vehicle.html">
                    <v-list-item-icon />
                    <v-list-item-title>Vehicle</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Japanese/Word/word_weather.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Verb_Detail/verb_type.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="../MySite_1/Japanese/Kanji/kanji_basic.html">
                    <v-list-item-icon />
                    <v-list-item-title>Basic</v-list-item-title>
                </v-list-item>
            </v-list-group>
            ...
            <v-list-group :value="false" prepend-icon="mdi-gamepad-square-outline">
                ...
                <v-list-item href="../MySite_1/Game/game_kitty_hopper.html">
                    <v-list-item-icon />
                    <v-list-item-title>Kitty Hopper</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Game/game_catmodel.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-chef-hat">
                ...
                <v-list-item href="../MySite_1/Youtube/cooking_simple.html">
                    <v-list-item-icon />
                    <v-list-item-title>Simple</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Youtube/cooking_normal.html">
                    <v-list-item-icon />
                    <v-list-item-title>Normal</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Youtube/cooking_intricate.html">
                    <v-list-item-icon />
                    <v-list-item-title>Intricate</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Youtube/cooking_chinese.html">
                    <v-list-item-icon />
                    <v-list-item-title>Chinese</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Youtube/cooking_pasta.html">
                    <v-list-item-icon />
                    <v-list-item-title>Pasta</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Youtube/cooking_ramen.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-sprout">
                ...
                <v-list-item href="../MySite_1/Vegetable/onion.html">
                    <v-list-item-icon />
                    <v-list-item-title>Onion</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Vegetable/spinach.html">
                    <v-list-item-icon />
                    <v-list-item-title>Spinach</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Vegetable/chrysanthemum.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-music">
                ...
                <v-list-item href="../MySite_1/Youtube/utada_hikaru.html">
                    <v-list-item-icon />
                    <v-list-item-title>Utada Hikaru</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Youtube/showgo.html">
                    <v-list-item-icon />
                    <v-list-item-title>Show-Go</v-list-item-title>
                </v-list-item>
                <v-list-item href="../MySite_1/Youtube/ua.html">
                    <v-list-item-icon />
