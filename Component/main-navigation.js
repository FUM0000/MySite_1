Vue.component('main-navigation', {
    ...
    <v-navigation-drawer class="blue-grey lighten-5" v-model="drawer_local" app right>
        ...
        <!-- Home -->
        <v-btn href="http://35.73.34.134/index.html" class="font-weight-black non-underline" block dark>
            Home
        </v-btn>
        ...
        <v-list nav dense>
            ...
            <v-list-item href="http://35.73.34.134/Japanese/greeting.html">
                <v-list-item-icon><v-icon>mdi-human-greeting-variant</v-icon></v-list-item-icon>
                <v-list-item-title>Greeting</v-list-item-title>
            </v-list-item>

            <v-list-item href="http://35.73.34.134/Japanese/word_limited_period.html">
            ...
            <v-list-group :value="false" prepend-icon="mdi-book-open-page-variant-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/character.html">
                    <v-list-item-icon />
                    <v-list-item-title>Character</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/grammar.html">
                    <v-list-item-icon />
                    <v-list-item-title>Grammar</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/verb_type.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_basic.html">
                    <v-list-item-icon />
                    <v-list-item-title>Basic</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_verb.html">
                    <v-list-item-icon />
                    <v-list-item-title>Verb</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_adjective.html">
                    <v-list-item-icon />
                    <v-list-item-title>Adjective</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_adjective_special.html">
                    <v-list-item-icon />
                    <v-list-item-title>Special Adjective</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_adverb.html">
                    <v-list-item-icon />
                    <v-list-item-title>Adverb</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_house.html">
                    <v-list-item-icon />
                    <v-list-item-title>House</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_road.html">
                    <v-list-item-icon />
                    <v-list-item-title>Road</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_body.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_nature.html">
                    <v-list-item-icon />
                    <v-list-item-title>Nature</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_plant.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_vehicle.html">
                    <v-list-item-icon />
                    <v-list-item-title>Vehicle</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_company.html">
                    <v-list-item-icon />
                    <v-list-item-title>Company</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_school.html">
                    <v-list-item-icon />
                    <v-list-item-title>School</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_park.html">
                    <v-list-item-icon />
                    <v-list-item-title>Park</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_gym.html">
                    <v-list-item-icon />
                    <v-list-item-title>Gym</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_weather.html">
                    <v-list-item-icon />
                    <v-list-item-title>Weather</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_time.html">
                    <v-list-item-icon />
                    <v-list-item-title>Time</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_personal_computer.html">
                    <v-list-item-icon />
                    <v-list-item-title>Personal computer</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_kitchen.html">
                    <v-list-item-icon />
                    <v-list-item-title>Kitchen</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_game.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_supermarket.html">
                    <v-list-item-icon />
                    <v-list-item-title>Supermarket</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_restaurant.html">
                    <v-list-item-icon />
                    <v-list-item-title>Restaurant</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_clothing_store.html">
                    <v-list-item-icon />
                    <v-list-item-title>Clothing store</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_hospital.html">
                    <v-list-item-icon />
                    <v-list-item-title>Hospital</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_cafe.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_hello_talk.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_food.html">
                    <v-list-item-icon />
                    <v-list-item-title>Food</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_sushi.html">
                    <v-list-item-icon />
                    <v-list-item-title>Sushi</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Japanese/Word/word_italian.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Japanese/kanji_basic.html">
                    <v-list-item-icon />
                    <v-list-item-title>Basic</v-list-item-title>
                </v-list-item>
            </v-list-group>
            ...
            <v-list-group :value="false" prepend-icon="mdi-library-outline">
                ...
                <v-list-item href="http://35.73.34.134/Spanish/dele_a1.html">
                    <v-list-item-icon />
                    <v-list-item-title>DELE - A1</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Spanish/dele_a2.html">
                    <v-list-item-icon />
                    <v-list-item-title>DELE - A2</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Spanish/mei.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-gamepad-square-outline">
                ...
                <v-list-item href="http://35.73.34.134/Game/game_kitty_hopper.html">
                    <v-list-item-icon />
                    <v-list-item-title>Kitty Hopper</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Game/game_catmodel.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-noodles">
                ...
                <v-list-item href="http://35.73.34.134/Youtube/dish_simple.html">
                    <v-list-item-icon />
                    <v-list-item-title>Simple</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Youtube/dish_normal.html">
                    <v-list-item-icon />
                    <v-list-item-title>Normal</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Youtube/dish_chinese.html">
                    <v-list-item-icon />
            ...
            <v-list-group :value="false" prepend-icon="mdi-music">
                ...
                <v-list-item href="http://35.73.34.134/Youtube/utada_hikaru.html">
                    <v-list-item-icon />
                    <v-list-item-title>Utada Hikaru</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Youtube/showgo.html">
                    <v-list-item-icon />
                    <v-list-item-title>Show-Go</v-list-item-title>
                </v-list-item>
                <v-list-item href="http://35.73.34.134/Youtube/ua.html">
                    <v-list-item-icon />
